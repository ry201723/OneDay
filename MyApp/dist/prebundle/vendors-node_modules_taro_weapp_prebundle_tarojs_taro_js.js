...
/* harmony import */ var _chunk_QWAJYNNO_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./chunk-QWAJYNNO.js */ "./node_modules/.taro/weapp/prebundle/chunk-QWAJYNNO.js");
...
var init_isNativeReflectConstruct = (0,_chunk_P7VEE7PG_js__WEBPACK_IMPORTED_MODULE_3__.__esm)({
    "node_modules/@babel/runtime/helpers/esm/isNativeReflectConstruct.js" () {}
});
...
function _createSuper(Derived) {
    ...
    return function _createSuperInternal() {
        var Super = (0,_chunk_QWAJYNNO_js__WEBPACK_IMPORTED_MODULE_0__._getPrototypeOf)(Derived), result;
        if (hasNativeReflectConstruct) {
            var NewTarget = (0,_chunk_QWAJYNNO_js__WEBPACK_IMPORTED_MODULE_0__._getPrototypeOf)(this).constructor;
            result = Reflect.construct(Super, arguments, NewTarget);
        } else {
            result = Super.apply(this, arguments);
        }
        return (0,_chunk_QWAJYNNO_js__WEBPACK_IMPORTED_MODULE_0__._possibleConstructorReturn)(this, result);
    };
}
var init_createSuper = (0,_chunk_P7VEE7PG_js__WEBPACK_IMPORTED_MODULE_3__.__esm)({
    "node_modules/@babel/runtime/helpers/esm/createSuper.js" () {
        (0,_chunk_QWAJYNNO_js__WEBPACK_IMPORTED_MODULE_0__.init_getPrototypeOf)();
        init_isNativeReflectConstruct();
        (0,_chunk_QWAJYNNO_js__WEBPACK_IMPORTED_MODULE_0__.init_possibleConstructorReturn)();
    }
});
...
function _objectSpread2(target) {
    for(var i = 1; i < arguments.length; i++){
        ...
        i % 2 ? ownKeys(Object(source), true).forEach(function(key) {
            (0,_chunk_QWAJYNNO_js__WEBPACK_IMPORTED_MODULE_0__._defineProperty)(target, key, source[key]);
...
var init_objectSpread2 = (0,_chunk_P7VEE7PG_js__WEBPACK_IMPORTED_MODULE_3__.__esm)({
    "node_modules/@babel/runtime/helpers/esm/objectSpread2.js" () {
        (0,_chunk_QWAJYNNO_js__WEBPACK_IMPORTED_MODULE_0__.init_defineProperty)();
    }
});
...
function isObject(x) {
    return x && (0,_chunk_QWAJYNNO_js__WEBPACK_IMPORTED_MODULE_0__._typeof)(x) === "object";
}
...
function getPreload(current) {
    return function(key, val) {
        current.preloadData = isObject(key) ? key : (0,_chunk_QWAJYNNO_js__WEBPACK_IMPORTED_MODULE_0__._defineProperty)({}, key, val);
    };
}
...
var isBadObj, DEFAULT_EMPTY_ARRAY, NO_DEFAULT_VALUE, DEFAULT_TRUE, DEFAULT_FALSE, touchEvents, animation, PLATFORM_TYPE, Events2, isWebPlatform, HOOK_TYPE, defaultMiniLifecycle, TaroHooks, ENV_TYPE, isWeb, Chain, Link, interceptors, defaultDesignWidth, defaultDesignRatio, defaultBaseFontSize, Taro;
var init_index_esm = (0,_chunk_P7VEE7PG_js__WEBPACK_IMPORTED_MODULE_3__.__esm)({
    "node_modules/@tarojs/api/dist/index.esm.js" () {
        (0,_chunk_QWAJYNNO_js__WEBPACK_IMPORTED_MODULE_0__.init_typeof)();
        (0,_chunk_LUBGUOEO_js__WEBPACK_IMPORTED_MODULE_1__.init_runtime_esm)();
        (0,_chunk_QWAJYNNO_js__WEBPACK_IMPORTED_MODULE_0__.init_toConsumableArray)();
        (0,_chunk_QWAJYNNO_js__WEBPACK_IMPORTED_MODULE_0__.init_inherits)();
        init_createSuper();
        (0,_chunk_QWAJYNNO_js__WEBPACK_IMPORTED_MODULE_0__.init_classCallCheck)();
        (0,_chunk_QWAJYNNO_js__WEBPACK_IMPORTED_MODULE_0__.init_createClass)();
        init_objectSpread2();
        (0,_chunk_QWAJYNNO_js__WEBPACK_IMPORTED_MODULE_0__.init_defineProperty)();
        ...
        Events2 = function() {
            function Events3(opts) {
                (0,_chunk_QWAJYNNO_js__WEBPACK_IMPORTED_MODULE_0__._classCallCheck)(this, Events3);
                var _a;
                this.callbacks = (_a = opts === null || opts === void 0 ? void 0 : opts.callbacks) !== null && _a !== void 0 ? _a : {};
            }
            (0,_chunk_QWAJYNNO_js__WEBPACK_IMPORTED_MODULE_0__._createClass)(Events3, [
                {
                    key: "on",
                    value: function on(eventName, callback, context) {
                        ...
                        eventName = eventName.split(Events3.eventSplitter);
                ...
                },
                {
                    ...
                    value: function off(events, callback, context) {
                        ...
                        events = events ? events.split(Events3.eventSplitter) : Object.keys(calls);
                ...
                },
                {
                    ...
                    value: function trigger(events) {
                        ...
                        events = events.split(Events3.eventSplitter);
        ...
        Events2.eventSplitter = ",";
        isWebPlatform = function isWebPlatform2() {
            return false;
        };
        (function(HOOK_TYPE2) {
        ...
        TaroHooks = function(_Events) {
            (0,_chunk_QWAJYNNO_js__WEBPACK_IMPORTED_MODULE_0__._inherits)(TaroHooks2, _Events);
            var _super = _createSuper(TaroHooks2);
            function TaroHooks2(hooks, opts) {
                var _this2;
                (0,_chunk_QWAJYNNO_js__WEBPACK_IMPORTED_MODULE_0__._classCallCheck)(this, TaroHooks2);
            ...
            (0,_chunk_QWAJYNNO_js__WEBPACK_IMPORTED_MODULE_0__._createClass)(TaroHooks2, [
                {
                    key: "tapOneOrMany",
                ...
                },
                {
                    ...
                    value: function tap(hookName, callback) {
                        ...
                        var _hooks$hookName = hooks[hookName], type = _hooks$hookName.type, initial = _hooks$hookName.initial;
        ...
        new TaroHooks({
            ...
            getEventCenter: TaroHook(HOOK_TYPE.SINGLE, function(Events3) {
                return new Events3();
            }),
        ...
        Chain = function() {
            function Chain2(requestParams, interceptors2, index) {
                (0,_chunk_QWAJYNNO_js__WEBPACK_IMPORTED_MODULE_0__._classCallCheck)(this, Chain2);
                this.index = index || 0;
                this.requestParams = requestParams;
                this.interceptors = interceptors2 || [];
            }
            (0,_chunk_QWAJYNNO_js__WEBPACK_IMPORTED_MODULE_0__._createClass)(Chain2, [
                {
                    key: "proceed",
        ...
        Link = function() {
            function Link2(interceptor) {
                (0,_chunk_QWAJYNNO_js__WEBPACK_IMPORTED_MODULE_0__._classCallCheck)(this, Link2);
                this.taroInterceptor = interceptor;
                this.chain = new Chain();
            }
            (0,_chunk_QWAJYNNO_js__WEBPACK_IMPORTED_MODULE_0__._createClass)(Link2, [
                {
                    key: "request",
        ...
        Taro = {
            ...
            Link,
            interceptors,
            Current: _chunk_LUBGUOEO_js__WEBPACK_IMPORTED_MODULE_1__.Current,
            getCurrentInstance: _chunk_LUBGUOEO_js__WEBPACK_IMPORTED_MODULE_1__.getCurrentInstance,
            options: _chunk_LUBGUOEO_js__WEBPACK_IMPORTED_MODULE_1__.options,
            nextTick: _chunk_LUBGUOEO_js__WEBPACK_IMPORTED_MODULE_1__.nextTick,
            eventCenter: _chunk_LUBGUOEO_js__WEBPACK_IMPORTED_MODULE_1__.eventCenter,
            Events: _chunk_MPOY2A6B_js__WEBPACK_IMPORTED_MODULE_2__.Events,
            getInitPxTransform
        };
        Taro.initPxTransform = getInitPxTransform(Taro);
        Taro.preload = getPreload(_chunk_LUBGUOEO_js__WEBPACK_IMPORTED_MODULE_1__.Current);
...
var require_taro = (0,_chunk_P7VEE7PG_js__WEBPACK_IMPORTED_MODULE_3__.__commonJS)({
    "node_modules/@tarojs/taro/index.js" (exports, module) {
        var { hooks  } = ((0,_chunk_LUBGUOEO_js__WEBPACK_IMPORTED_MODULE_1__.init_runtime_esm)(), (0,_chunk_P7VEE7PG_js__WEBPACK_IMPORTED_MODULE_3__.__toCommonJS)(_chunk_LUBGUOEO_js__WEBPACK_IMPORTED_MODULE_1__.runtime_esm_exports));
